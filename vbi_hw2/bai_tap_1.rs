...
fn main() {
    ...
    //chúng ta chỉ quan tâm đến vòng đời của v1, vì v2 không được sử dụng sau đoạn code này, nên không cần clone v2
...
fn main() {
    ...
    //reference của v1, để tạo ra vector mới, vòng đời của v1 vẫn tiếp tục
    let diff2  = vec_diff(v1, &diff);
    println!("{:?}", all(diff, 3));
}
//==============================================================